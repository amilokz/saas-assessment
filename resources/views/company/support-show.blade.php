...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="card mt-4">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('company.support.reply', $message) }}">
                    @csrf
                    <div class="mb-3">
        ...
        <div class="mt-4">
            ...
            <form method="POST" action="{{ route('company.support.close', $message) }}" class="d-inline">
                @csrf
            ...
            <form method="POST" action="{{ route('company.support.reopen', $message) }}" class="d-inline">
                @csrf
